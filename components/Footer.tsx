      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              <h4 className="font-medium text-text mb-4">导航</h4>
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href="/tools" className="text-text-muted hover:text-accent transition-colors">
                    工具列表
                  </Link>
                </li>
                <li>
            ...
            <div>
              <h4 className="font-medium text-text mb-4">关于</h4>
              <ul className="space-y-2 text-sm">
                <li>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-medium text-text mb-4">联系</h4>
            <p className="text-text-muted text-sm mb-4">
              有问题或建议？随时联系我。
            </p>
            <a
              href="mailto:hello@aiworkshop.com"
